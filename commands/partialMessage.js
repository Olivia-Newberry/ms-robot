exports.run = async (client, message, args, level, command) => { // eslint-disable-line no-unused-vars
	...
	//grab first word of message content
	//if (args[0].toLowerCase() == "bee" || message.content.toLowerCase().split(" ")[0].toLowerCase() == "bee"){
	if (args.some(el => el.toLowerCase() == "bee") || message.content.toLowerCase().split(" ")[0].toLowerCase() == "bee"){
